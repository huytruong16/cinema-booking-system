...
export class CreateVoucherDto {
  ...
  @ApiPropertyOptional({
    example: 'Giảm giá cuối năm cho khách hàng VIP',
  ...
  @ApiProperty({
    example: DiscountTypeEnum.CODINH,
  ...
  @ApiPropertyOptional({
    example: 50000,
    description: 'Giá trị đơn tối thiểu áp dụng voucher',
  })
  @IsOptional()
  ...
  @IsEnum(VoucherTargetEnum, {
    message: 'Đối tượng áp dụng voucher không hợp lệ',
  })
  DoiTuongApDung: VoucherTargetEnum;

  @ApiProperty({
    example: '2025-10-29T00:00:00.000Z',
    description: 'Ngày bắt đầu khuyến mãi (ISO string)',
  })
  ...
  @ApiProperty({
    ...
    description: 'Ngày kết thúc khuyến mãi (ISO string)',
  })
  @IsDateString({}, { message: 'Ngày kết thúc phải là định dạng ngày hợp lệ' })
  NgayKetThuc: string;

  @ApiProperty({
    example: DiscountStatusEnum.CONHOATDONG,
