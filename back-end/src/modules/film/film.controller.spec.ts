...
describe('FilmController', () => {
    ...
    it('getAllFilmFormats -> gọi service', async () => {
        ...
        expect(service.getAllFilmFormats).toHaveBeenCalled();
        expect(result).toEqual({ data: [] });
    });
    ...
    it('createFilm -> gọi service với file', async () => {
        ...
        expect(service.createFilm).toHaveBeenCalledWith(dto, poster, backdrop);
        expect(result).toEqual({ message: 'ok' });
    });

    it('updateFilm -> throw nếu id không hợp lệ', async () => {
        await expect(
            controller.updateFilm('abc', {}, {}),
    ...
    it('updateFilm -> gọi service', async () => {
        ...
        expect(service.updateFilm).toHaveBeenCalled();
    ...
    it('removeFilm -> gọi service', async () => {
        ...
        expect(service.removeFilm).toHaveBeenCalled();
    ...
    it('createFilmVersion -> gọi service', async () => {
        ...
        expect(service.createFilmVersion).toHaveBeenCalled();
        expect(result).toEqual({ message: 'ok' });
    });

    it('updateFilmVersion -> throw nếu id sai', async () => {
        await expect(
            controller.update('abc', {} as any),
        ).rejects.toThrow(BadRequestException);
    });
    ...
    it('removeFilmVersion -> gọi service', async () => {
        ...
        expect(service.removeFilmVersion).toHaveBeenCalled();
        expect(result).toEqual({ message: 'ok' });
    });
});
