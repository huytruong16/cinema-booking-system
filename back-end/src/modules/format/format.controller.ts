import { Controller, Get, Param, BadRequestException, Body, Patch, Delete, Post } from '@nestjs/common';
...
export class FormatController {
    ...
    @ApiParam({ name: 'id', description: 'Mã định dạng cần cập nhật', required: true })
    @ApiBody({ type: CreateFormatDto })
