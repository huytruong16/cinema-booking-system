...
export class AuthService {
    ...
    async register(dto: RegisterDto) {
        ...
        this.mailService.sendOTPEmail(email, 'Xác minh tài khoản', `${otp}`, hoTen, 'register');
    ...
    async forgotPassword(dto: ForgotPasswordDto) {
        ...
        this.mailService.sendOTPEmail(email, 'Đặt lại mật khẩu', `${otp}`, user.HoTen, 'forgot-password');
