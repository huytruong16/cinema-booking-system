                    ...
                    {seatList.map((seatNum, index) => {
                        ...
                        if (!meta) {
                          if (isDouble) {
                            type = 'doi';
                            price = basePrice * 2; 
                          } else if (['D', 'E', 'F'].includes(rowName)) {
                            type = 'vip';
                        ...
                        return (
                            <Button
                                ...
                                className={cn(
                                    ...
                                    type === 'thuong' && "bg-slate-800 border-slate-700 hover:bg-slate-700 hover:border-slate-600 text-slate-300",
                                    type === 'vip' && "bg-yellow-900/20 border-yellow-700/50 hover:bg-yellow-900/40 text-yellow-500",
                                    type === 'doi' && "bg-purple-900/20 border-purple-700/50 hover:bg-purple-900/40 text-purple-400",
