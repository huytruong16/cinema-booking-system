...
import {
  movieVersionService,
  MovieVersion,
} from "@/services/movie-version.service";
...
export default function MovieVersionManagementPage() {
  ...
  const [currentVersion, setCurrentVersion] = useState<MovieVersion | null>(
    null
  );
    ...
    <div className="space-y-6">
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="sm:max-w-[500px] bg-white">
          <DialogHeader>
            <DialogTitle>
              {currentVersion ? "Cập Nhật Phiên Bản" : "Tạo Phiên Bản Mới"}
            </DialogTitle>
            <DialogDescription>
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <div className="col-span-3">
                <Select
                  ...
                  onValueChange={(val) =>
                    setFormData({ ...formData, MaPhim: val })
                  }
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <div className="col-span-3">
                <Select
                  ...
                  onValueChange={(val) =>
                    setFormData({ ...formData, MaDinhDang: val })
                  }
                >
                  <SelectTrigger>
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <div className="col-span-3">
                <Select
                  ...
                  onValueChange={(val) =>
                    setFormData({ ...formData, MaNgonNgu: val })
                  }
                >
                  <SelectTrigger>
